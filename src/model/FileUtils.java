...
public class FileUtils {
  ...
  public static AbstractImage load(String path) {
    // Get BufferedImage from the picture of the path.
    int[] rgb = new int[3];
    File file = new File(path);
    BufferedImage bi = null;
    ...
    return new Image(data.length, data[0].length, data);
  }

  public static void save(AbstractImage image, String path) throws IOException {
